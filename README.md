...
La definición temporal primaria y las sensibilidades por inicio de prescripción
y por alcance del cultivo se versionan en `config/suspected_infection.json`, se
materializan por separado y se delimitan en
[`docs/suspected_infection_sensitivity_contract.md`](docs/suspected_infection_sensitivity_contract.md).
