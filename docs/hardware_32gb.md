...
- El etiquetado del proxy de shock conserva índices de fila de lactatos por
  ingreso y vasopresores por estancia una sola vez; no duplica un DataFrame por
  grupo ni vuelve a recorrer ambas tablas completas por cada estancia séptica.
